...
exports.help = {
    ...
    category: "botlist",
    aliases: ["botsite"],
    description: "Configurer le site web d'un bot.",
    usage: "setsite <id bot> <invitation | none>",
    example: [`setsite 782667133716791316 https://google.fr`, `botsite 782667133716791316 none`]
}