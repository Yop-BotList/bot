...
exports.run = async (client, message, args) => {
        ...
        if(message.content.toLowerCase().match('client.disconnect()')) return message.channel.send(client.no + " | Attention ! J'ai détecté le mot \"client.disconnect()\" dans ton message. Évite cela si tu veux garder ton accès à cette commande.")
