...
exports.help = {
    ...
    category: "botlist",
    aliases: ["botsupport"],
    description: "Configurer le serveur support d'un bot.",
    usage: "setsupport <id bot> <invitation | none>",
    example: [`setsupport 782667133716791316 https://discord.gg/3dQeTg9Vz3`, `botsupport 782667133716791316 none`]
}