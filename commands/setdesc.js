...
exports.help = {
    ...
    category: "botlist",
    aliases: ["botdesc"],
    description: "Configurer la description d'un bot.",
    usage: "setdesc <id bot> <description | none>",
    example: [`setdesc 782667133716791316 Bot multi-fonctions`, `botdesc 782667133716791316 none`]
}