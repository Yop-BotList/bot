                    ...
                    embeds: [
                        {
                            ...
                            fields: [
                                ...
                                value: `> ${db.prefix && db.prefix !== "/" && db.prefix !== "/cmd" && db.prefix !== "/cmds" && db.prefix !== "/command" && db.prefix !== "/commands" ? db.prefix :  ""} ${db.supportSlashs && db.supportSlashs === true ? client.emotes.badges.supportSlashs : ""}`,
                                inline: true
                                }, {
